...
if args.nn == 'rnn':
    filename_train_data = '{}_base_pe/{}_d{}_p{}_trnsz{}'.format(args.c_type, args.c_type, args.d,
                                                                       format(args.p, '.3f'), args.trnsz)
    filename_test_data = '{}_base_pe/{}_d{}_p{}_trnsz{}_eval_seed1.hdf5'.format(args.c_type, args.c_type, args.d,
                                                                       format(args.p, '.3f'), args.testsz)
